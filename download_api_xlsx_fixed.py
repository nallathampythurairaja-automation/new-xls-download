...
def main() -> None:
    ...
    payload = r.json()
    rows = _extract_rows(payload, preferred_keys=["reqTradeSummery", "reqTradeSummary", "tradeSummary", "data"])
    ...
    # Format nicely (if openpyxl installed)
    # If the API uses changePercentage as a percent-number (e.g., -0.0797 meaning -0.0797%), show as %
